...
Сценарий: Cинхронизация с использованием push
    Допустим Я добавляю параметр "-P" для команды "gitsync3"
...
Сценарий: Cинхронизация с использованием pull и push
    Допустим Я добавляю параметр "-GP" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "URLРепозитория"
    Когда Я выполняю команду "gitsync3"
...
Сценарий: Cинхронизация c использованием push-tags
    Допустим Я добавляю параметр "-P" для команды "gitsync3"
    И Я добавляю параметр "--push-tags" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "URLРепозитория"
    Когда Я выполняю команду "gitsync3"
...
Сценарий: Cинхронизация c использованием push-every-n-commits
    Допустим Я добавляю параметр "-P" для команды "gitsync3"
    И Я добавляю параметр "--push-n-commits 1" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "URLРепозитория"
    Когда Я выполняю команду "gitsync3"
...
Сценарий: Cинхронизация хранилища все вместе
    Допустим Я добавляю параметр "-PGTn=2" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "URLРепозитория"
    Когда Я выполняю команду "gitsync3"
