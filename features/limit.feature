...
Сценарий: Cинхронизация с использованием limit
    Допустим Я добавляю параметр "-l 1" для команды "gitsync3"
...
Сценарий: Cинхронизация c использованием maxversion
    Допустим Я добавляю параметр "--maxversion 2" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    Когда Я выполняю команду "gitsync3"
    Тогда Вывод команды "gitsync3" содержит "ИНФОРМАЦИЯ - Завершена синхронизации с git"
...
Сценарий: Cинхронизация c использованием minversion
    Допустим Я добавляю параметр "--minversion 5" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    Когда Я выполняю команду "gitsync3"
    Тогда Вывод команды "gitsync3" содержит "ИНФОРМАЦИЯ - Завершена синхронизации с git"
...
Сценарий: Cинхронизация хранилища все вместе
    Допустим Я добавляю параметр "--limit 3" для команды "gitsync3"
    И Я добавляю параметр "--minversion 2" для команды "gitsync3"
    И Я добавляю параметр "--maxversion 4" для команды "gitsync3"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "КаталогХранилища1С"
    И Я добавляю позиционный параметр для команды "gitsync3" из переменной "ПутьКаталогаИсходников"
    Когда Я выполняю команду "gitsync3"
    Тогда Вывод команды "gitsync3" содержит "ИНФОРМАЦИЯ - Завершена синхронизации с git"
