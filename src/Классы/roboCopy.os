...
Функция Описание() Экспорт
	Возврат "(Windows-only) Плагин заменяет механизм переноса исходников из временного каталога в рабочий на robocopy,
	| чтобы избежать ошибок с длиной пути к файлу";
КонецФункции
...
Процедура ПриРегистрацииКомандыПриложения(ИмяКоманды, КлассРеализации, Парсер) Экспорт // BSLLS:UnusedParameters-off
